...
<div class="wrapper">
  ...
  <div class="input-group ">
                      ...
                      <input type="text" class="form-control" name="id" value="<?php echo $row['id'];?>" id="student_id" readonly >
           ...
           <span class="error"> <?php echo $nameErr;?></span>
                ...
                <span class="error"> <?php echo $emailErr;?></span>
                     ...
                     <div class="input-group ">
                      ...
                      <input type="password" name="password" class="form-control" id="latitude" value="<?php echo $row['password']; ?>" placeholder="Enter Password">
